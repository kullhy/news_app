...
Future<List<Article>> searchNewsData(String searchValue) async {
  try {
    String url =
        "https://newsapi.org/v2/everything?q=$searchValue&lang=us&from=2023-07-15&sortBy=publishedAt&apiKey=d0feb78512ac453ebe15444e2f6fe72f";
